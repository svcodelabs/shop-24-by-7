  ...
  return (
    <div className="w-full p-4 mt-4 overflow-x-auto border rounded-md lg:mt-0 border-gray-200 sm:p-5 lg:py-8 2xl:py-10 lg:px-7 2xl:px-12 bg-white">
      <div className="flex flex-col w-full">
        <div className="w-full flex flex-col md:flex-row justify-between items-center mt-3 gap-y-4 md:gap-x-4">
        ...
        <div className="mt-2 md:mt-5 lg:mt-8 flex flex-col md:flex-row md:justify-between md:items-center px-7 py-2">
          <div className="">
          ...
          <div className="hidden md:flex w-[1px] h-[164px] bg-[#E4E4E4]"></div>
          <div className="">
